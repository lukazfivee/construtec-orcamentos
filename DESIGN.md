...
colors:
  ...
  status-sent-border: "#dec3f5"
  status-approved-text: "#176d39"
  status-approved-bg: "#f0f9f2"
  status-approved-border: "#94d3a8"
  status-rejected-text: "#9e2323"
  status-rejected-bg: "#fdeeee"
  status-rejected-border: "#f9bebe"
typography:
  headline:
...
components:
  ...
  status-draft:
    ...
    textColor: "{colors.status-draft-text}"
    borderColor: "{colors.status-draft-border}"
  ...
  status-review:
    ...
    borderColor: "{colors.status-review-border}"
    typography: "{typography.label}"
    rounded: "{rounded.sm}"
    padding: "2px 8px"
    border: "1px solid"
  status-sent:
    backgroundColor: "{colors.status-sent-bg}"
    textColor: "{colors.status-sent-text}"
    borderColor: "{colors.status-sent-border}"
    typography: "{typography.label}"
    rounded: "{rounded.sm}"
    padding: "2px 8px"
    border: "1px solid"
  status-approved:
    ...
    textColor: "{colors.status-approved-text}"
  ...
  status-rejected:
    ...
    textColor: "{colors.status-rejected-text}"
